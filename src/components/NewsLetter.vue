                                ...
                                <div class="hm-foot-email">
                                    <form action="" @submit="submitData">
                                        <div class="foot-email-box">
                                            <input v-model="email" class="form-control" placeholder="Enter Email Here....">
                                        </div><!--/.foot-email-box-->
                                        <div class="foot-email-subscribe">
<!--                                            <span><i class="fa fa-location-arrow"></i></span>-->
                                            <button type="submit" class="fa fa-location-arrow" onclick="window.location.href='#newsLetter'"></button>
                                        </div>
                                    </form><!--/.foot-email-icon-->
                                </div><!--/.hm-foot-email-->
                            </div><!--/.hm-footer-widget-->
                        </div><!--/.col-->
                    </div><!--/.row-->
...
<script>
    export default {
        ...
        methods: {
            submitData() {
                if (!this.email) {
                    this.$toasted.error("Please enter valid email address");
                }
                else {
